...
I mean doesn't it make sense? Balancing your data seems like a smart idea. Well, I don't quite agree with that point. <br>
...
Why do we use a test set at all? - It is to get a grasp on how the model works on new unseen data. There is no guarantee that new data will be stratified. In fact, data tends to drift and starts looking differently with time, which is the opposite of stratification. <br>
